...
%     close all;
    ...
    f = figure('Name', ['A for sequence length' num2str(N(iterN))]);
    ...
    saveas(f, ['./Figs/A_seqlen_' num2str(N(iterN))], 'epsc');

    g = figure('Name', ['Phi for sequence length' num2str(N(iterN))]);
    ...
    saveas(g, ['./Figs/Phi_seqlen_' num2str(N(iterN))], 'epsc');
